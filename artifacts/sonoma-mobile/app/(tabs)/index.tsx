...
const MY_LIST_KEY = "monterey-my-list-mobile";
...
const WELCOME_KEY = "monterey-welcome-seen-mobile";
        ...
        <View style={[styles.welcomeCard, { backgroundColor: colors.card }]}>
          ...
          <View style={[styles.welcomeHeader, { borderBottomColor: colors.border }]}>
            ...
            <Text style={[styles.welcomeSubtitle, { color: colors.mutedForeground }]}>
              {total} personally curated spots — {wineries} wineries, {restaurants} restaurants, {farmstands} farm stands, and {artisans} artisan makers (abalone farmers, cheesemakers, bakers, roasters, and more) — verified by a professional chef who actually goes to all of them.
            </Text>
          </View>
      ...
      <View style={[styles.container, { backgroundColor: colors.background }]} testID="map-screen">
        <View style={[styles.webHeader, { paddingTop: topInset + 12, backgroundColor: colors.card, borderBottomColor: colors.border }]}>
          <View style={styles.webHeaderRow}>
            ...
            <Text style={[styles.webHeaderTitle, { color: colors.foreground }]}>Monterey Map</Text>
  ...
  return (
    <View style={styles.container} testID="map-screen">
      ...
      <View style={[styles.headerPill, { top: topInset + 8, backgroundColor: colors.card }]}>
        ...
        <Text style={[styles.headerPillText, { color: colors.foreground }]}>Monterey</Text>
        <View style={[styles.countBadge, { backgroundColor: colors.primary }]}>
          <Text style={[styles.countBadgeText, { color: colors.primaryForeground }]}>
            {filteredMarkers.length}
          </Text>
